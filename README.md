...
Copyright (c) 2022 Fynd, and contributors to this fork. The upstream copyright
notice is retained: this project began as a fork of Fynd's `aio-requests`, and
MIT requires the original notice to travel with the code. Current maintenance is
by Arjunsingh Yadav.
